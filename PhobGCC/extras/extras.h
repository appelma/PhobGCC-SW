...
#ifdef EXTRAS_DIGITALCSTICK
	//-----------------------------------------
	dcs::extrasDCSConfigSlot = EXTRAS_UP;
	//-----------------------------------------
	debug_println("Extra: Enabling digital cstick functionality...");
	extrasConfigAssign(dcs::extrasDCSConfigSlot, dcs::toggle, dcs::dcsconfig);
#endif
